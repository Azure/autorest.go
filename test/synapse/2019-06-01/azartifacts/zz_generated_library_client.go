...
func (client *libraryClient) BeginCreate(ctx context.Context, libraryName string, options *LibraryBeginCreateOptions) (LibraryCreatePollerResponse, error) {
	...
	result.PollUntilDone = func(ctx context.Context, frequency time.Duration) (LibraryCreateResponse, error) {
		return poller.pollUntilDone(ctx, frequency)
	}
	return result, nil
}

// ResumeCreate creates a new LibraryCreatePoller from the specified resume token.
// token - The value must come from a previous call to LibraryCreatePoller.ResumeToken().
func (client *libraryClient) ResumeCreate(ctx context.Context, token string) (LibraryCreatePollerResponse, error) {
...
func (client *libraryClient) BeginDelete(ctx context.Context, libraryName string, options *LibraryBeginDeleteOptions) (LibraryDeletePollerResponse, error) {
	...
	result.Poller = poller
	result.PollUntilDone = func(ctx context.Context, frequency time.Duration) (LibraryDeleteResponse, error) {
		return poller.pollUntilDone(ctx, frequency)
	}
	return result, nil
}

// ResumeDelete creates a new LibraryDeletePoller from the specified resume token.
// token - The value must come from a previous call to LibraryDeletePoller.ResumeToken().
func (client *libraryClient) ResumeDelete(ctx context.Context, token string) (LibraryDeletePollerResponse, error) {
...
func (client *libraryClient) BeginFlush(ctx context.Context, libraryName string, options *LibraryBeginFlushOptions) (LibraryFlushPollerResponse, error) {
	...
	result.Poller = poller
	result.PollUntilDone = func(ctx context.Context, frequency time.Duration) (LibraryFlushResponse, error) {
		return poller.pollUntilDone(ctx, frequency)
	}
	return result, nil
}

// ResumeFlush creates a new LibraryFlushPoller from the specified resume token.
// token - The value must come from a previous call to LibraryFlushPoller.ResumeToken().
func (client *libraryClient) ResumeFlush(ctx context.Context, token string) (LibraryFlushPollerResponse, error) {
