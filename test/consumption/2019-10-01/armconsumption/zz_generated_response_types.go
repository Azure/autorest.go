...
// EventsListResponse contains the response from method Events.List.
...
// EventsListResult contains the result from method Events.List.
...
// LotsListResponse contains the response from method Lots.List.
...
// LotsListResult contains the result from method Lots.List.
type LotsListResult struct {
	Lots
}
