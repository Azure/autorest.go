...
func (client *Client) MultipleInheritanceServiceClientOperations() MultipleInheritanceServiceClientOperations {
	return &multipleInheritanceServiceClientOperations{Client: client}
}
