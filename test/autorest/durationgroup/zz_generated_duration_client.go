...
// options - DurationGetInvalidOptions contains the optional parameters for the DurationClient.GetInvalid method.
...
// If the operation fails it returns the *Error error type.
// options - DurationGetNullOptions contains the optional parameters for the DurationClient.GetNull method.
...
// If the operation fails it returns the *Error error type.
// options - DurationGetPositiveDurationOptions contains the optional parameters for the DurationClient.GetPositiveDuration
// method.
...
// options - DurationPutPositiveDurationOptions contains the optional parameters for the DurationClient.PutPositiveDuration
// method.
