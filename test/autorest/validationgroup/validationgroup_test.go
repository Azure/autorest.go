...
func newAutoRestValidationTestClient() validationgroup.AutoRestValidationTestOperations {
	return validationgroup.NewAutoRestValidationTestClient(validationgroup.NewDefaultClient(nil), "")
}
