...
// options - AutoRestValidationTestGetWithConstantInPathOptions contains the optional parameters for the AutoRestValidationTest.GetWithConstantInPath
// method.
...
// If the operation fails it returns a generic error.
// options - AutoRestValidationTestPostWithConstantInBodyOptions contains the optional parameters for the AutoRestValidationTest.PostWithConstantInBody
// method.
...
// options - AutoRestValidationTestValidationOfBodyOptions contains the optional parameters for the AutoRestValidationTest.ValidationOfBody
// method.
...
// resourceGroupName - Required string between 3 and 10 chars with pattern [a-zA-Z0-9]+.
// id - Required int multiple of 10 from 100 to 1000.
// options - AutoRestValidationTestValidationOfMethodParametersOptions contains the optional parameters for the AutoRestValidationTest.ValidationOfMethodParameters
// method.
