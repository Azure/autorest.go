...
// ToPtr returns a *ContentType1AutoGenerated pointing to the current value.
func (c ContentType1AutoGenerated) ToPtr() *ContentType1AutoGenerated {
	return &c
}
...
// ToPtr returns a *ContentType1AutoGenerated2 pointing to the current value.
func (c ContentType1AutoGenerated2) ToPtr() *ContentType1AutoGenerated2 {
	return &c
}
