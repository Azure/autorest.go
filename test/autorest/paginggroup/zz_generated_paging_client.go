...
// If the operation fails it returns a generic error.
// options - PagingGetMultiplePagesFailureOptions contains the optional parameters for the Paging.GetMultiplePagesFailure method.
...
// If the operation fails it returns a generic error.
// options - PagingGetMultiplePagesFailureURIOptions contains the optional parameters for the Paging.GetMultiplePagesFailureURI method.
...
// options - PagingGetMultiplePagesFragmentNextLinkOptions contains the optional parameters for the Paging.GetMultiplePagesFragmentNextLink method.
...
// If the operation fails it returns a generic error.
// CustomParameterGroup - CustomParameterGroup contains a group of parameters for the Paging.GetMultiplePagesFragmentWithGroupingNextLink method.
...
// If the operation fails it returns a generic error.
// options - PagingBeginGetMultiplePagesLROOptions contains the optional parameters for the Paging.BeginGetMultiplePagesLRO method.
...
// has 10 pages
// If the operation fails it returns a generic error.
// options - PagingGetMultiplePagesRetryFirstOptions contains the optional parameters for the Paging.GetMultiplePagesRetryFirst method.
...
// If the operation fails it returns a generic error.
// options - PagingGetMultiplePagesRetrySecondOptions contains the optional parameters for the Paging.GetMultiplePagesRetrySecond method.
...
// If the operation fails it returns a generic error.
// PagingGetMultiplePagesWithOffsetOptions - PagingGetMultiplePagesWithOffsetOptions contains the optional parameters for the Paging.GetMultiplePagesWithOffset method.
...
// If the operation fails it returns a generic error.
// options - PagingGetNullNextLinkNamePagesOptions contains the optional parameters for the Paging.GetNullNextLinkNamePages method.
...
// If the operation fails it returns a generic error.
// options - PagingGetPagingModelWithItemNameWithXMSClientNameOptions contains the optional parameters for the Paging.GetPagingModelWithItemNameWithXMSClientName method.
