...
func newHTTPClientFailureClient() httpinfrastructuregroup.HTTPClientFailureOperations {
	return httpinfrastructuregroup.NewHTTPClientFailureClient(httpinfrastructuregroup.NewDefaultClient(nil))
}
