...
// properties
func (client PolymorphismClient) GetComplicated() (result SalmonModel, err error) {
	req, err := client.GetComplicatedPreparer()
	if err != nil {
...
func (client PolymorphismClient) GetComplicatedPreparer() (*http.Request, error) {
...
// properties
//
func (client PolymorphismClient) PutComplicated(complexBody Salmon) (result autorest.Response, err error) {
	req, err := client.PutComplicatedPreparer(complexBody)
	if err != nil {
...
func (client PolymorphismClient) PutComplicatedPreparer(complexBody Salmon) (*http.Request, error) {
	preparer := autorest.CreatePreparer(
		autorest.AsJSON(),
		autorest.AsPut(),
		autorest.WithBaseURL(client.BaseURI),
