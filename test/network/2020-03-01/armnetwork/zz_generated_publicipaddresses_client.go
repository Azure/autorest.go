...
// options - PublicIPAddressesBeginDeleteOptions contains the optional parameters for the PublicIPAddresses.BeginDelete method.
...
// resourceGroupName - The name of the resource group.
// publicIPAddressName - The name of the subnet.
// options - PublicIPAddressesGetOptions contains the optional parameters for the PublicIPAddresses.Get method.
...
// If the operation fails it returns the *CloudError error type.
// resourceGroupName - The name of the resource group.
// options - PublicIPAddressesListOptions contains the optional parameters for the PublicIPAddresses.List method.
...
// If the operation fails it returns the *CloudError error type.
// options - PublicIPAddressesListAllOptions contains the optional parameters for the PublicIPAddresses.ListAll method.
...
// options - PublicIPAddressesUpdateTagsOptions contains the optional parameters for the PublicIPAddresses.UpdateTags method.
