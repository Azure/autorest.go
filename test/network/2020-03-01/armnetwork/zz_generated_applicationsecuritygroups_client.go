...
// options - ApplicationSecurityGroupsBeginCreateOrUpdateOptions contains the optional parameters for the ApplicationSecurityGroups.BeginCreateOrUpdate method.
...
// resourceGroupName - The name of the resource group.
// applicationSecurityGroupName - The name of the application security group.
// options - ApplicationSecurityGroupsBeginDeleteOptions contains the optional parameters for the ApplicationSecurityGroups.BeginDelete method.
...
// If the operation fails it returns the *CloudError error type.
// resourceGroupName - The name of the resource group.
// options - ApplicationSecurityGroupsListOptions contains the optional parameters for the ApplicationSecurityGroups.List method.
...
// If the operation fails it returns the *CloudError error type.
// options - ApplicationSecurityGroupsListAllOptions contains the optional parameters for the ApplicationSecurityGroups.ListAll method.
...
// options - ApplicationSecurityGroupsUpdateTagsOptions contains the optional parameters for the ApplicationSecurityGroups.UpdateTags method.
