...
// MarshalJSON implements the json.Marshaller interface for type AliasListItem.
func (a AliasListItem) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AliasListItem.
func (a *AliasListItem) UnmarshalJSON(data []byte) error {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AliasListResponse.
func (a *AliasListResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "aliases":
			err = unpopulate(val, "Aliases", &a.Aliases)
			delete(rawMsg, key)
		case "nextLink":
