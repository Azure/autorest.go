...
const goMappings = {
    ...
    'mediatypesgroup': ['media_types.json', '--remove-unreferenced-types', '--normalize-operation-name=false'],
    'mediatypesgroupwithnormailzedoperationname': ['media_types.json', '--remove-unreferenced-types'],
