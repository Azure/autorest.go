...
export abstract class BaseCodeGenerator {
  public constructor(public context: GenerateContext) {}
    ...
    protected renderAndWrite(model: any, templateFileName: string, outputFileName: string, extraParam: Record<string, unknown> = {}, jsFunc: Record<string, unknown> = {}): void {
    ...
    protected getFilePrefix(configName: string): void {
