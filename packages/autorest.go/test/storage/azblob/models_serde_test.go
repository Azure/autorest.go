...
func TestListContainersSegmentResponseRoundTrip(t *testing.T) {
  ...
  <NextMarker>video</NextMarker>
	...
	assertEqual(t, "Container[0].Etag", *resp.ContainerItems[0].Properties.Etag, "0x8CACB9BD7C6B1B2")
...
func TestContainerItemWithMetadataRoundTrip(t *testing.T) {
  ...
  <Metadata>
	...
	assertEqual(t, "Etag", *item.Properties.Etag, "0x8CACB9BD7C6B1B2")
...
func TestBlockListRoundTrip(t *testing.T) {
  ...
  <UncommittedBlocks>
	...
	assertEqual(t, "CommittedBlocks[0].Name", *blockList.CommittedBlocks[0].Name, "BlockId001")
	assertEqual(t, "CommittedBlocks[0].Size", *blockList.CommittedBlocks[0].Size, int64(4194304))
	assertEqual(t, "CommittedBlocks[1].Name", *blockList.CommittedBlocks[1].Name, "BlockId002")
	assertEqual(t, "UncommittedBlocks[0].Name", *blockList.UncommittedBlocks[0].Name, "BlockId003")
	assertEqual(t, "UncommittedBlocks[1].Name", *blockList.UncommittedBlocks[1].Name, "BlockId004")
...
func TestListBlobsFlatSegmentResponseRoundTrip(t *testing.T) {
  ...
  <NextMarker />
	...
	assertEqual(t, "Blob.Name.Content", *blob.Name.Content, "my-blob.txt")
	assertEqual(t, "Blob.Deleted", *blob.Deleted, false)
	assertEqual(t, "Blob.Properties.Etag", *blob.Properties.Etag, "0x8CACB9BD7C6B1B2")
...
func TestListBlobsHierarchySegmentResponseRoundTrip(t *testing.T) {
  ...
  <NextMarker />
	...
	assertEqual(t, "BlobPrefix[0].Name", *resp.Segment.BlobPrefixes[0].Name.Content, "subdir/")
}
...
// TestStorageErrorJSON tests JSON marshal/unmarshal of StorageError.
func TestStorageErrorJSON(t *testing.T) {
	jsonData := `{"Message":"The specified container does not exist."}`

	var se StorageError
	if err := json.Unmarshal([]byte(jsonData), &se); err != nil {
		t.Fatal(err)
	}

	assertEqual(t, "Message", *se.Message, "The specified container does not exist.")
	...
	if err := json.Unmarshal(out, &se2); err != nil {
		t.Fatal(err)
	}
	assertEqual(t, "round-trip Message", *se2.Message, "The specified container does not exist.")
}
...
func TestPropertiesInternalTimeFieldsRoundTrip(t *testing.T) {
  ...
  <LeaseState>available</LeaseState>
	...
	assertEqual(t, "Etag", *props.Etag, "0x8CACB9BD7C6B1B2")
