...
func (client *ContainerClient) acquireLeaseCreateRequest(ctx context.Context, containerName string, comp Enum16, restype Enum11, options *ContainerClientAcquireLeaseOptions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
...
func (client *ContainerClient) breakLeaseCreateRequest(ctx context.Context, containerName string, comp Enum16, restype Enum11, options *ContainerClientBreakLeaseOptions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) changeLeaseCreateRequest(ctx context.Context, containerName string, comp Enum16, restype Enum11, leaseID string, proposedLeaseID string, options *ContainerClientChangeLeaseOptions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) createCreateRequest(ctx context.Context, containerName string, restype Enum11, options *ContainerClientCreateOptions, containerCpkScopeInfo *ContainerCpkScopeInfo) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) deleteCreateRequest(ctx context.Context, containerName string, restype Enum11, options *ContainerClientDeleteOptions, leaseAccessConditions *LeaseAccessConditions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) filterBlobsCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum10, options *ContainerClientFilterBlobsOptions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) getAccessPolicyCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum13, options *ContainerClientGetAccessPolicyOptions, leaseAccessConditions *LeaseAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) getPropertiesCreateRequest(ctx context.Context, containerName string, restype Enum11, options *ContainerClientGetPropertiesOptions, leaseAccessConditions *LeaseAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
//     method.
func (client *ContainerClient) NewListBlobFlatSegmentPager(containerName string, restype Enum11, comp Enum5, options *ContainerClientListBlobFlatSegmentOptions) *runtime.Pager[ContainerClientListBlobFlatSegmentResponse] {
...
func (client *ContainerClient) listBlobFlatSegmentCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum5, options *ContainerClientListBlobFlatSegmentOptions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
//     method.
func (client *ContainerClient) NewListBlobHierarchySegmentPager(containerName string, restype Enum11, comp Enum5, delimiter string, options *ContainerClientListBlobHierarchySegmentOptions) *runtime.Pager[ContainerClientListBlobHierarchySegmentResponse] {
...
func (client *ContainerClient) listBlobHierarchySegmentCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum5, delimiter string, options *ContainerClientListBlobHierarchySegmentOptions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) releaseLeaseCreateRequest(ctx context.Context, containerName string, comp Enum16, restype Enum11, leaseID string, options *ContainerClientReleaseLeaseOptions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) renameCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum15, sourceContainerName string, options *ContainerClientRenameOptions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) renewLeaseCreateRequest(ctx context.Context, containerName string, comp Enum16, restype Enum11, leaseID string, options *ContainerClientRenewLeaseOptions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) restoreCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum14, options *ContainerClientRestoreOptions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) setAccessPolicyCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum13, options *ContainerClientSetAccessPolicyOptions, leaseAccessConditions *LeaseAccessConditions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) setMetadataCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum12, options *ContainerClientSetMetadataOptions, leaseAccessConditions *LeaseAccessConditions, modifiedAccessConditions *ModifiedAccessConditions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
...
func (client *ContainerClient) submitBatchCreateRequest(ctx context.Context, containerName string, restype Enum11, comp Enum9, contentLength int64, multipartContentType string, body io.ReadSeekCloser, options *ContainerClientSubmitBatchOptions) (*policy.Request, error) {
	urlPath := "/{containerName}"
	if containerName == "" {
		return nil, errors.New("parameter containerName cannot be empty")
	}
