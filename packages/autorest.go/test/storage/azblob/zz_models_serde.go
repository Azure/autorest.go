...
func (c ContainerProperties) MarshalXML(enc *xml.Encoder, start xml.StartElement) error {
	...
	aux := &struct {
		*alias
		DeletedTime  *datetime.DateTimeRFC1123 `xml:"DeletedTime"`
		LastModified *datetime.DateTimeRFC1123 `xml:"Last-Modified"`
	}{
		alias:        (*alias)(&c),
		DeletedTime:  (*datetime.DateTimeRFC1123)(c.DeletedTime),
		LastModified: (*datetime.DateTimeRFC1123)(c.LastModified),
	}
	return enc.EncodeElement(aux, start)
}
...
func (g GeoReplication) MarshalXML(enc *xml.Encoder, start xml.StartElement) error {
	...
	aux := &struct {
		*alias
		LastSyncTime *datetime.DateTimeRFC1123 `xml:"LastSyncTime"`
	}{
		alias:        (*alias)(&g),
		LastSyncTime: (*datetime.DateTimeRFC1123)(g.LastSyncTime),
	}
	return enc.EncodeElement(aux, start)
}
...
func (p PropertiesInternal) MarshalXML(enc *xml.Encoder, start xml.StartElement) error {
	...
	aux := &struct {
		*alias
		AccessTierChangeTime        *datetime.DateTimeRFC1123 `xml:"AccessTierChangeTime"`
		ContentMD5                  *string                   `xml:"Content-MD5"`
		CopyCompletionTime          *datetime.DateTimeRFC1123 `xml:"CopyCompletionTime"`
		CreationTime                *datetime.DateTimeRFC1123 `xml:"Creation-Time"`
		DeletedTime                 *datetime.DateTimeRFC1123 `xml:"DeletedTime"`
		ExpiresOn                   *datetime.DateTimeRFC1123 `xml:"Expiry-Time"`
		ImmutabilityPolicyExpiresOn *datetime.DateTimeRFC1123 `xml:"ImmutabilityPolicyUntilDate"`
		LastAccessedOn              *datetime.DateTimeRFC1123 `xml:"LastAccessTime"`
		LastModified                *datetime.DateTimeRFC1123 `xml:"Last-Modified"`
	}{
		alias:                       (*alias)(&p),
		AccessTierChangeTime:        (*datetime.DateTimeRFC1123)(p.AccessTierChangeTime),
		CopyCompletionTime:          (*datetime.DateTimeRFC1123)(p.CopyCompletionTime),
		CreationTime:                (*datetime.DateTimeRFC1123)(p.CreationTime),
		DeletedTime:                 (*datetime.DateTimeRFC1123)(p.DeletedTime),
		ExpiresOn:                   (*datetime.DateTimeRFC1123)(p.ExpiresOn),
		ImmutabilityPolicyExpiresOn: (*datetime.DateTimeRFC1123)(p.ImmutabilityPolicyExpiresOn),
		LastAccessedOn:              (*datetime.DateTimeRFC1123)(p.LastAccessedOn),
		LastModified:                (*datetime.DateTimeRFC1123)(p.LastModified),
	}
	if p.ContentMD5 != nil {
...
func (u UserDelegationKey) MarshalXML(enc *xml.Encoder, start xml.StartElement) error {
	...
	aux := &struct {
		*alias
		SignedExpiry *datetime.DateTimeRFC3339 `xml:"SignedExpiry"`
		SignedStart  *datetime.DateTimeRFC3339 `xml:"SignedStart"`
	}{
		alias:        (*alias)(&u),
		SignedExpiry: (*datetime.DateTimeRFC3339)(u.SignedExpiry),
		SignedStart:  (*datetime.DateTimeRFC3339)(u.SignedStart),
	}
	return enc.EncodeElement(aux, start)
}
