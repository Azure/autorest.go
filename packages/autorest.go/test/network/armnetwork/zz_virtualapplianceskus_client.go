...
//     method.
func (client *VirtualApplianceSKUsClient) Get(ctx context.Context, skuName string, options *VirtualApplianceSKUsClientGetOptions) (resp VirtualApplianceSKUsClientGetResponse, err error) {
