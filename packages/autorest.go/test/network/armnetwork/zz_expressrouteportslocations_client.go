...
//     method.
func (client *ExpressRoutePortsLocationsClient) Get(ctx context.Context, locationName string, options *ExpressRoutePortsLocationsClientGetOptions) (resp ExpressRoutePortsLocationsClientGetResponse, err error) {
