...
//     method.
func (client *AzureFirewallsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, azureFirewallName string, parameters AzureFirewall, options *AzureFirewallsClientBeginCreateOrUpdateOptions) (resp *runtime.Poller[AzureFirewallsClientCreateOrUpdateResponse], err error) {
...
//     method.
func (client *AzureFirewallsClient) BeginDelete(ctx context.Context, resourceGroupName string, azureFirewallName string, options *AzureFirewallsClientBeginDeleteOptions) (resp *runtime.Poller[AzureFirewallsClientDeleteResponse], err error) {
	if options == nil || options.ResumeToken == "" {
...
func (client *AzureFirewallsClient) Get(ctx context.Context, resourceGroupName string, azureFirewallName string, options *AzureFirewallsClientGetOptions) (resp AzureFirewallsClientGetResponse, err error) {
	ctx, endSpan := runtime.StartSpan(ctx, "AzureFirewallsClient.Get", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
//     method.
func (client *AzureFirewallsClient) BeginListLearnedPrefixes(ctx context.Context, resourceGroupName string, azureFirewallName string, options *AzureFirewallsClientBeginListLearnedPrefixesOptions) (resp *runtime.Poller[AzureFirewallsClientListLearnedPrefixesResponse], err error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2022-09-01
func (client *AzureFirewallsClient) listLearnedPrefixes(ctx context.Context, resourceGroupName string, azureFirewallName string, options *AzureFirewallsClientBeginListLearnedPrefixesOptions) (resp *http.Response, err error) {
...
//     method.
func (client *AzureFirewallsClient) BeginUpdateTags(ctx context.Context, resourceGroupName string, azureFirewallName string, parameters TagsObject, options *AzureFirewallsClientBeginUpdateTagsOptions) (resp *runtime.Poller[AzureFirewallsClientUpdateTagsResponse], err error) {
	if options == nil || options.ResumeToken == "" {
