...
func (a AlertProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "appearedAtDateTime", a.AppearedAtDateTime)
...
func (a *AlertProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "appearedAtDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "AppearedAtDateTime", &a.AppearedAtDateTime)
			delete(rawMsg, key)
...
func (c ContainerProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "createdDateTime", c.CreatedDateTime)
...
func (c *ContainerProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "CreatedDateTime", &c.CreatedDateTime)
			delete(rawMsg, key)
		case "dataFormat":
...
func (j Job) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	datetime.PopulateDateTimeRFC3339(objectMap, "endTime", j.EndTime)
	populate(objectMap, "error", j.Error)
	populate(objectMap, "id", j.ID)
	populate(objectMap, "name", j.Name)
	populate(objectMap, "percentComplete", j.PercentComplete)
	populate(objectMap, "properties", j.Properties)
	datetime.PopulateDateTimeRFC3339(objectMap, "startTime", j.StartTime)
...
func (j *Job) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "EndTime", &j.EndTime)
			delete(rawMsg, key)
		case "error":
		...
		case "properties":
			...
			delete(rawMsg, key)
		case "startTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "StartTime", &j.StartTime)
			delete(rawMsg, key)
		case "status":
...
func (o OrderStatus) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "updateDateTime", o.UpdateDateTime)
	return json.Marshal(objectMap)
}
...
func (o *OrderStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "trackingInformation":
			...
			delete(rawMsg, key)
		case "updateDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "UpdateDateTime", &o.UpdateDateTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
...
func (p PeriodicTimerSourceInfo) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "startTime", p.StartTime)
...
func (p *PeriodicTimerSourceInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "schedule":
			...
			delete(rawMsg, key)
		case "startTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "StartTime", &p.StartTime)
			delete(rawMsg, key)
		case "topic":
...
func (r RefreshDetails) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "lastCompletedRefreshJobTimeInUTC", r.LastCompletedRefreshJobTimeInUTC)
...
func (r *RefreshDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastCompletedRefreshJobTimeInUTC":
			err = datetime.UnpopulateDateTimeRFC3339(val, "LastCompletedRefreshJobTimeInUTC", &r.LastCompletedRefreshJobTimeInUTC)
			delete(rawMsg, key)
		case "lastJob":
...
func (r RemoteSupportSettings) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "expirationTimeStampInUTC", r.ExpirationTimeStampInUTC)
...
func (r *RemoteSupportSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expirationTimeStampInUTC":
			err = datetime.UnpopulateDateTimeRFC3339(val, "ExpirationTimeStampInUTC", &r.ExpirationTimeStampInUTC)
			delete(rawMsg, key)
...
func (r ResourceMoveDetails) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "operationInProgressLockTimeoutInUTC", r.OperationInProgressLockTimeoutInUTC)
	return json.Marshal(objectMap)
}
...
func (r *ResourceMoveDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "operationInProgressLockTimeoutInUTC":
			err = datetime.UnpopulateDateTimeRFC3339(val, "OperationInProgressLockTimeoutInUTC", &r.OperationInProgressLockTimeoutInUTC)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
func (s SupportPackageRequestProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "maximumTimeStamp", s.MaximumTimeStamp)
	datetime.PopulateDateTimeRFC3339(objectMap, "minimumTimeStamp", s.MinimumTimeStamp)
	return json.Marshal(objectMap)
}
...
func (s *SupportPackageRequestProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "maximumTimeStamp":
			err = datetime.UnpopulateDateTimeRFC3339(val, "MaximumTimeStamp", &s.MaximumTimeStamp)
			delete(rawMsg, key)
		case "minimumTimeStamp":
			err = datetime.UnpopulateDateTimeRFC3339(val, "MinimumTimeStamp", &s.MinimumTimeStamp)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
func (u UpdateSummaryProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	datetime.PopulateDateTimeRFC3339(objectMap, "deviceLastScannedDateTime", u.DeviceLastScannedDateTime)
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "inProgressDownloadJobStartedDateTime", u.InProgressDownloadJobStartedDateTime)
	populate(objectMap, "inProgressInstallJobId", u.InProgressInstallJobID)
	datetime.PopulateDateTimeRFC3339(objectMap, "inProgressInstallJobStartedDateTime", u.InProgressInstallJobStartedDateTime)
	datetime.PopulateDateTimeRFC3339(objectMap, "lastCompletedDownloadJobDateTime", u.LastCompletedDownloadJobDateTime)
	populate(objectMap, "lastCompletedDownloadJobId", u.LastCompletedDownloadJobID)
	datetime.PopulateDateTimeRFC3339(objectMap, "lastCompletedInstallJobDateTime", u.LastCompletedInstallJobDateTime)
	populate(objectMap, "lastCompletedInstallJobId", u.LastCompletedInstallJobID)
	datetime.PopulateDateTimeRFC3339(objectMap, "lastCompletedScanJobDateTime", u.LastCompletedScanJobDateTime)
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "lastSuccessfulInstallJobDateTime", u.LastSuccessfulInstallJobDateTime)
	datetime.PopulateDateTimeRFC3339(objectMap, "lastSuccessfulScanJobTime", u.LastSuccessfulScanJobTime)
...
func (u *UpdateSummaryProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "deviceLastScannedDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "DeviceLastScannedDateTime", &u.DeviceLastScannedDateTime)
			delete(rawMsg, key)
		...
		case "inProgressDownloadJobStartedDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "InProgressDownloadJobStartedDateTime", &u.InProgressDownloadJobStartedDateTime)
			delete(rawMsg, key)
		...
		case "inProgressInstallJobStartedDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "InProgressInstallJobStartedDateTime", &u.InProgressInstallJobStartedDateTime)
			delete(rawMsg, key)
		case "lastCompletedDownloadJobDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "LastCompletedDownloadJobDateTime", &u.LastCompletedDownloadJobDateTime)
			delete(rawMsg, key)
		...
		case "lastCompletedInstallJobDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "LastCompletedInstallJobDateTime", &u.LastCompletedInstallJobDateTime)
			delete(rawMsg, key)
		...
		case "lastCompletedScanJobDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "LastCompletedScanJobDateTime", &u.LastCompletedScanJobDateTime)
			delete(rawMsg, key)
		...
		case "lastSuccessfulInstallJobDateTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "LastSuccessfulInstallJobDateTime", &u.LastSuccessfulInstallJobDateTime)
			delete(rawMsg, key)
		case "lastSuccessfulScanJobTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "LastSuccessfulScanJobTime", &u.LastSuccessfulScanJobTime)
			delete(rawMsg, key)
