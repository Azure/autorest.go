...
func (o *OrdersServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := o.srv.BeginCreateOrUpdate(req.Context(), deviceNameUnescaped, resourceGroupNameUnescaped, body, nil)
...
func (o *OrdersServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := o.srv.BeginDelete(req.Context(), deviceNameUnescaped, resourceGroupNameUnescaped, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (o *OrdersServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := o.srv.Get(req.Context(), deviceNameUnescaped, resourceGroupNameUnescaped, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (o *OrdersServerTransport) dispatchNewListByDataBoxEdgeDevicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByDataBoxEdgeDevicePager == nil {
		...
		resp := o.srv.NewListByDataBoxEdgeDevicePager(deviceNameUnescaped, resourceGroupNameUnescaped, nil)
...
func (o *OrdersServerTransport) dispatchListDCAccessCode(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := o.srv.ListDCAccessCode(req.Context(), deviceNameUnescaped, resourceGroupNameUnescaped, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
