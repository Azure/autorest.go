...
// The returned JobsServerTransport instance is connected to an instance of armdataboxedge.JobsClient by way of the
...
func (j *JobsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := j.srv.Get(req.Context(), matches[regex.SubexpIndex("deviceName")], matches[regex.SubexpIndex("name")], matches[regex.SubexpIndex("resourceGroupName")], nil)
