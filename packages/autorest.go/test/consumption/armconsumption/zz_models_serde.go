...
func (b BudgetTimePeriod) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	datetime.PopulateDateTimeRFC3339(objectMap, "endDate", b.EndDate)
	datetime.PopulateDateTimeRFC3339(objectMap, "startDate", b.StartDate)
	return json.Marshal(objectMap)
}
...
func (b *BudgetTimePeriod) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "EndDate", &b.EndDate)
			delete(rawMsg, key)
		case "startDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "StartDate", &b.StartDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
func (c CreditBalanceSummary) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "currentBalanceInBillingCurrency", c.CurrentBalanceInBillingCurrency)
...
func (c *CreditBalanceSummary) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "currentBalance":
			...
			delete(rawMsg, key)
		case "currentBalanceInBillingCurrency":
			err = unpopulate(val, "CurrentBalanceInBillingCurrency", &c.CurrentBalanceInBillingCurrency)
			delete(rawMsg, key)
...
func (e EventProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "transactionDate", e.TransactionDate)
	return json.Marshal(objectMap)
}
...
func (e *EventProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "transactionDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "TransactionDate", &e.TransactionDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
func (f *ForecastProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "charge":
			err = unpopulate(val, "Charge", &f.Charge)
			delete(rawMsg, key)
		case "chargeType":
			err = unpopulate(val, "ChargeType", &f.ChargeType)
			delete(rawMsg, key)
		case "confidenceLevels":
			err = unpopulate(val, "ConfidenceLevels", &f.ConfidenceLevels)
			delete(rawMsg, key)
		case "currency":
			err = unpopulate(val, "Currency", &f.Currency)
			delete(rawMsg, key)
		case "grain":
			err = unpopulate(val, "Grain", &f.Grain)
			delete(rawMsg, key)
		case "usageDate":
			err = unpopulate(val, "UsageDate", &f.UsageDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", f, err)
...
// MarshalJSON implements the json.Marshaller interface for type ForecastPropertiesConfidenceLevelsItem.
func (f ForecastPropertiesConfidenceLevelsItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "bound", f.Bound)
	populate(objectMap, "percentage", f.Percentage)
	populate(objectMap, "value", f.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ForecastPropertiesConfidenceLevelsItem.
func (f *ForecastPropertiesConfidenceLevelsItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "bound":
			err = unpopulate(val, "Bound", &f.Bound)
			delete(rawMsg, key)
		case "percentage":
			err = unpopulate(val, "Percentage", &f.Percentage)
			delete(rawMsg, key)
		case "value":
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ForecastsListResult.
func (f *ForecastsListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
...
func (l LegacyReservationRecommendationProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "firstUsageDate", l.FirstUsageDate)
...
func (l *LegacyReservationRecommendationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "costWithNoReservedInstances":
			...
			delete(rawMsg, key)
		case "firstUsageDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "FirstUsageDate", &l.FirstUsageDate)
			delete(rawMsg, key)
...
func (l LegacyReservationTransactionProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "eventDate", l.EventDate)
...
func (l *LegacyReservationTransactionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "description":
			...
			delete(rawMsg, key)
		case "eventDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "EventDate", &l.EventDate)
			delete(rawMsg, key)
		case "eventType":
...
func (l LegacyUsageDetailProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "billingPeriodEndDate", l.BillingPeriodEndDate)
	datetime.PopulateDateTimeRFC3339(objectMap, "billingPeriodStartDate", l.BillingPeriodStartDate)
	...
	populate(objectMap, "costCenter", l.CostCenter)
	datetime.PopulateDateTimeRFC3339(objectMap, "date", l.Date)
...
func (l *LegacyUsageDetailProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "billingPeriodEndDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "BillingPeriodEndDate", &l.BillingPeriodEndDate)
			delete(rawMsg, key)
		case "billingPeriodStartDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "BillingPeriodStartDate", &l.BillingPeriodStartDate)
			delete(rawMsg, key)
		...
		case "costCenter":
			...
			delete(rawMsg, key)
		case "date":
			err = datetime.UnpopulateDateTimeRFC3339(val, "Date", &l.Date)
			delete(rawMsg, key)
		case "effectivePrice":
...
func (l LotProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "expirationDate", l.ExpirationDate)
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "startDate", l.StartDate)
	return json.Marshal(objectMap)
}
...
func (l *LotProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "creditCurrency":
			...
			delete(rawMsg, key)
		case "expirationDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "ExpirationDate", &l.ExpirationDate)
			delete(rawMsg, key)
		case "originalAmount":
		...
		case "source":
			...
			delete(rawMsg, key)
		case "startDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "StartDate", &l.StartDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", l, err)
...
func (m ManagementGroupAggregatedCostProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "usageEnd", m.UsageEnd)
	datetime.PopulateDateTimeRFC3339(objectMap, "usageStart", m.UsageStart)
	return json.Marshal(objectMap)
}
...
func (m *ManagementGroupAggregatedCostProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "marketplaceCharges":
			...
			delete(rawMsg, key)
		case "usageEnd":
			err = datetime.UnpopulateDateTimeRFC3339(val, "UsageEnd", &m.UsageEnd)
			delete(rawMsg, key)
		case "usageStart":
			err = datetime.UnpopulateDateTimeRFC3339(val, "UsageStart", &m.UsageStart)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
func (m ModernReservationRecommendationProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "firstUsageDate", m.FirstUsageDate)
...
func (m *ModernReservationRecommendationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "costWithNoReservedInstances":
			...
			delete(rawMsg, key)
		case "firstUsageDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "FirstUsageDate", &m.FirstUsageDate)
			delete(rawMsg, key)
		case "instanceFlexibilityGroup":
...
func (m ModernReservationTransactionProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "eventDate", m.EventDate)
...
func (m *ModernReservationTransactionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "description":
			...
			delete(rawMsg, key)
		case "eventDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "EventDate", &m.EventDate)
			delete(rawMsg, key)
		case "eventType":
...
func (m ModernUsageDetailProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "billingPeriodEndDate", m.BillingPeriodEndDate)
	datetime.PopulateDateTimeRFC3339(objectMap, "billingPeriodStartDate", m.BillingPeriodStartDate)
	populate(objectMap, "billingProfileId", m.BillingProfileID)
	populate(objectMap, "billingProfileName", m.BillingProfileName)
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "date", m.Date)
	populate(objectMap, "exchangeRate", m.ExchangeRate)
	datetime.PopulateDateTimeRFC3339(objectMap, "exchangeRateDate", m.ExchangeRateDate)
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "servicePeriodEndDate", m.ServicePeriodEndDate)
	datetime.PopulateDateTimeRFC3339(objectMap, "servicePeriodStartDate", m.ServicePeriodStartDate)
	populate(objectMap, "subscriptionGuid", m.SubscriptionGUID)
	populate(objectMap, "subscriptionName", m.SubscriptionName)
	populate(objectMap, "term", m.Term)
	populate(objectMap, "unitOfMeasure", m.UnitOfMeasure)
...
func (m *ModernUsageDetailProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "billingCurrencyCode":
			...
			delete(rawMsg, key)
		case "billingPeriodEndDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "BillingPeriodEndDate", &m.BillingPeriodEndDate)
			delete(rawMsg, key)
		case "billingPeriodStartDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "BillingPeriodStartDate", &m.BillingPeriodStartDate)
			delete(rawMsg, key)
		case "billingProfileId":
			err = unpopulate(val, "BillingProfileID", &m.BillingProfileID)
			delete(rawMsg, key)
		...
		case "customerTenantId":
			...
			delete(rawMsg, key)
		case "date":
			err = datetime.UnpopulateDateTimeRFC3339(val, "Date", &m.Date)
			delete(rawMsg, key)
		case "exchangeRate":
			err = unpopulate(val, "ExchangeRate", &m.ExchangeRate)
			delete(rawMsg, key)
		case "exchangeRateDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "ExchangeRateDate", &m.ExchangeRateDate)
			delete(rawMsg, key)
		...
		case "servicePeriodEndDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "ServicePeriodEndDate", &m.ServicePeriodEndDate)
			delete(rawMsg, key)
		case "servicePeriodStartDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "ServicePeriodStartDate", &m.ServicePeriodStartDate)
			delete(rawMsg, key)
		case "subscriptionGuid":
			err = unpopulate(val, "SubscriptionGUID", &m.SubscriptionGUID)
			delete(rawMsg, key)
...
func (r ReservationDetailProperties) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "usageDate", r.UsageDate)
...
func (r *ReservationDetailProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "totalReservedQuantity":
			...
			delete(rawMsg, key)
		case "usageDate":
			err = datetime.UnpopulateDateTimeRFC3339(val, "UsageDate", &r.UsageDate)
			delete(rawMsg, key)
		case "usedHours":
...
func (r ReservationRecommendationsListResult) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "totalCost", r.TotalCost)
	populate(objectMap, "value", r.Value)
	return json.Marshal(objectMap)
}
