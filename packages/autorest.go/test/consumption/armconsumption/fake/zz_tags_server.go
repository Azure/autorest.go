...
// The returned TagsServerTransport instance is connected to an instance of armconsumption.TagsClient by way of the
...
func (t *TagsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := t.srv.Get(req.Context(), matches[regex.SubexpIndex("scope")], nil)
