...
// The returned PriceSheetServerTransport instance is connected to an instance of armconsumption.PriceSheetClient by way of the
...
func (p *PriceSheetServerTransport) dispatchGetByBillingPeriod(req *http.Request) (*http.Response, error) {
	if p.srv.GetByBillingPeriod == nil {
		return nil, &nonRetriableError{errors.New("method GetByBillingPeriod not implemented")}
	}
