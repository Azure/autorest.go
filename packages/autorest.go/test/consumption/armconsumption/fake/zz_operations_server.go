...
// The returned OperationsServerTransport instance is connected to an instance of armconsumption.OperationsClient by way of the
...
type OperationsServerTransport struct {
	...
	newListPager *azfake.PagerResponder[armconsumption.OperationsClientListResponse]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if o.newListPager == nil {
		...
		o.newListPager = &resp
		server.PagerResponderInjectNextLinks(o.newListPager, req, func(page *armconsumption.OperationsClientListResponse, createLink func() string) {
