...
// MediaTypesClientBodyThreeTypesWithJSONResponse contains the response from method MediaTypesClient.BodyThreeTypesWithJSON.
type MediaTypesClientBodyThreeTypesWithJSONResponse struct {
	Value *string
}
