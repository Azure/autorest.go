...
func (d *DatetimeServerTransport) dispatchGetInvalid(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, (*datetime.DateTimeRFC3339)(server.GetResponse(respr).Value), req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (d *DatetimeServerTransport) dispatchPutLocalNegativeOffsetMaxDateTime(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[datetime.DateTimeRFC3339](req)
	if err != nil {
		return nil, err
	}
