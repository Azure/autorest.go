...
func (d *Datetimerfc1123ServerTransport) dispatchGetInvalid(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, (*datetime.RFC1123)(server.GetResponse(respr).Value), req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (d *Datetimerfc1123ServerTransport) dispatchPutUTCMaxDateTime(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[datetime.RFC1123](req)
	if err != nil {
		return nil, err
	}
