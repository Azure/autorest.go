...
func (d *DateServerTransport) dispatchGetInvalidDate(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, (*datetime.DateType)(server.GetResponse(respr).Value), req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (d *DateServerTransport) dispatchPutMaxDate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[datetime.DateType](req)
	if err != nil {
		return nil, err
	}
