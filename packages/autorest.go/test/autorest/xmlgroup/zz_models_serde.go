...
func (a AccessPolicy) MarshalXML(enc *xml.Encoder, start xml.StartElement) error {
	...
	aux := &struct {
		*alias
		Expiry *datetime.DateTimeRFC3339 `xml:"Expiry"`
		Start  *datetime.DateTimeRFC3339 `xml:"Start"`
	}{
		alias:  (*alias)(&a),
		Expiry: (*datetime.DateTimeRFC3339)(a.Expiry),
		Start:  (*datetime.DateTimeRFC3339)(a.Start),
	}
...
func (b Banana) MarshalXML(enc *xml.Encoder, start xml.StartElement) error {
	...
	aux := &struct {
		*alias
		Expiration *datetime.DateTimeRFC3339 `xml:"expiration"`
	}{
		alias:      (*alias)(&b),
		Expiration: (*datetime.DateTimeRFC3339)(b.Expiration),
	}
	return enc.EncodeElement(aux, start)
}
...
func (b BlobProperties) MarshalXML(enc *xml.Encoder, start xml.StartElement) error {
	...
	aux := &struct {
		*alias
		...
		alias:              (*alias)(&b),
		CopyCompletionTime: (*datetime.DateTimeRFC1123)(b.CopyCompletionTime),
		DeletedTime:        (*datetime.DateTimeRFC1123)(b.DeletedTime),
		LastModified:       (*datetime.DateTimeRFC1123)(b.LastModified),
	}
	return enc.EncodeElement(aux, start)
}
