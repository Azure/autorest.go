...
// Don't use this type directly, use NewValueTypesNeverClientWithNoCredential() instead.
type ValueTypesNeverClient struct {
	internal *azcore.Client
	endpoint string
}

// ValueTypesNeverClientOptions contains the optional values for creating a [ValueTypesNeverClient].
type ValueTypesNeverClientOptions struct {
	azcore.ClientOptions
}

// NewValueTypesNeverClientWithNoCredential creates a new instance of ValueTypesNeverClient with the specified values.
//   - endpoint - Service host
//   - options - Contains optional client configuration. Pass nil to accept the default values.
func NewValueTypesNeverClientWithNoCredential(endpoint string, options *ValueTypesNeverClientOptions) (*ValueTypesNeverClient, error) {
	if options == nil {
		options = &ValueTypesNeverClientOptions{}
	}
	cl, err := azcore.NewClient(moduleName, moduleVersion, runtime.PipelineOptions{}, &options.ClientOptions)
	if err != nil {
		return nil, err
	}
	client := &ValueTypesNeverClient{
		endpoint: endpoint,
		internal: cl,
	}
	return client, nil
