...
func (n *NullableCollectionsStringServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if nullableCollectionsStringServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = nullableCollectionsStringServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to NullableCollectionsStringServerTransport
var nullableCollectionsStringServerTransportInterceptor interface {
