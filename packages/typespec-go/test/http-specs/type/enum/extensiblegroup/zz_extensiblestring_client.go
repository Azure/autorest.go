...
// Don't use this type directly, use NewExtensibleStringClientWithNoCredential() instead.
type ExtensibleStringClient struct {
	internal *azcore.Client
	endpoint string
}

// ExtensibleStringClientOptions contains the optional values for creating a [ExtensibleStringClient].
type ExtensibleStringClientOptions struct {
	azcore.ClientOptions
}

// NewExtensibleStringClientWithNoCredential creates a new instance of ExtensibleStringClient with the specified values.
//   - endpoint - Service host
//   - options - Contains optional client configuration. Pass nil to accept the default values.
func NewExtensibleStringClientWithNoCredential(endpoint string, options *ExtensibleStringClientOptions) (*ExtensibleStringClient, error) {
	if options == nil {
		options = &ExtensibleStringClientOptions{}
	}
	cl, err := azcore.NewClient(moduleName, moduleVersion, runtime.PipelineOptions{}, &options.ClientOptions)
	if err != nil {
		return nil, err
	}
	client := &ExtensibleStringClient{
		endpoint: endpoint,
		internal: cl,
	}
	return client, nil
