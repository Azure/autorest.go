...
func (x *XMLModelWithAttributesValueServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if xmlModelWithAttributesValueServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = xmlModelWithAttributesValueServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to XMLModelWithAttributesValueServerTransport
var xmlModelWithAttributesValueServerTransportInterceptor interface {
