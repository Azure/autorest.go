...
func TestFormDataClient_Basic(t *testing.T) {
	...
	require.NoError(t, err)
	defer jpgFile.Close()
	resp, err := client.NewFormDataClient().Basic(context.Background(), multipartgroup.MultiPartRequest{
		ID: "123",
...
func TestFormDataClient_BinaryArrayParts(t *testing.T) {
	...
	resp, err := client.NewFormDataClient().BinaryArrayParts(context.Background(), multipartgroup.BinaryArrayPartsRequest{
		ID: "123",
...
func TestFormDataClient_CheckFileNameAndContentType(t *testing.T) {
	...
	require.NoError(t, err)
	defer jpgFile.Close()
	resp, err := client.NewFormDataClient().CheckFileNameAndContentType(context.Background(), multipartgroup.MultiPartRequest{
		ID: "123",
		ProfileImage: streaming.MultipartContent{
			Body:        jpgFile,
...
func TestFormDataClient_Complex(t *testing.T) {
	...
	require.NoError(t, err)
	require.NoError(t, pngFile.Close())
	resp, err := client.NewFormDataClient().Complex(context.Background(), multipartgroup.ComplexPartsRequest{
...
func TestFormDataClient_JSONArrayParts(t *testing.T) {
	...
	require.NoError(t, err)
	defer jpgFile.Close()
	resp, err := client.NewFormDataClient().JSONArrayParts(context.Background(), multipartgroup.JSONArrayPartsRequest{
		PreviousAddresses: []multipartgroup.Address{
			{
				City: to.Ptr("Y"),
			},
...
func TestFormDataClient_JSONPart(t *testing.T) {
	...
	require.NoError(t, err)
	defer jpgFile.Close()
	resp, err := client.NewFormDataClient().JSONPart(context.Background(), multipartgroup.JSONPartRequest{
		Address: multipartgroup.Address{
			City: to.Ptr("X"),
		},
		ProfileImage: streaming.MultipartContent{
...
func TestFormDataClient_MultiBinaryParts(t *testing.T) {
	...
	require.NoError(t, err)
	defer pngFile.Close()
	resp, err := client.NewFormDataClient().MultiBinaryParts(context.Background(), multipartgroup.MultiBinaryPartsRequest{
		ProfileImage: streaming.MultipartContent{
			Body: jpgFile,
		},
