...
//     method.
func (client *LegacyCreateResourcePollViaOperationLocationClient) BeginCreateJob(ctx context.Context, body JobData, options *LegacyCreateResourcePollViaOperationLocationClientCreateJobOptions) (*runtime.Poller[LegacyCreateResourcePollViaOperationLocationClientCreateJobResponse], error) {
...
func (client *LegacyCreateResourcePollViaOperationLocationClient) createJob(ctx context.Context, body JobData, options *LegacyCreateResourcePollViaOperationLocationClientCreateJobOptions) (*http.Response, error) {
	var err error
...
func (client *LegacyCreateResourcePollViaOperationLocationClient) createJobCreateRequest(ctx context.Context, body JobData, options *LegacyCreateResourcePollViaOperationLocationClientCreateJobOptions) (*policy.Request, error) {
