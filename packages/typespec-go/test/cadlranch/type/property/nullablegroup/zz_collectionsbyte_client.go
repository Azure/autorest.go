...
// CollectionsByteClient contains the methods for the Type.Property.Nullable namespace.
// Don't use this type directly, use [NullableClient.NewCollectionsByteClient] instead.
