...
func (client *Int32ValueClient) Get(ctx context.Context, options *Int32ValueClientGetOptions) (Int32ValueClientGetResponse, error) {
	var err error
	const operationName = "Int32ValueClient.Get"
...
func (client *Int32ValueClient) Put(ctx context.Context, body map[string]*int32, options *Int32ValueClientPutOptions) (Int32ValueClientPutResponse, error) {
	var err error
	const operationName = "Int32ValueClient.Put"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *Int32ValueClient) putCreateRequest(ctx context.Context, body map[string]*int32, options *Int32ValueClientPutOptions) (*policy.Request, error) {
	urlPath := "/type/dictionary/int32"
