...
func (client *ScalarDecimal128VerifyClient) prepareVerifyCreateRequest(ctx context.Context, options *ScalarDecimal128VerifyClientPrepareVerifyOptions) (*policy.Request, error) {
...
func (client *ScalarDecimal128VerifyClient) verifyCreateRequest(ctx context.Context, body float64, options *ScalarDecimal128VerifyClientVerifyOptions) (*policy.Request, error) {
