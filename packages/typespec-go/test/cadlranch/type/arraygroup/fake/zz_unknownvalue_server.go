...
// UnknownValueServer is a fake server for instances of the arraygroup.UnknownValueClient type.
type UnknownValueServer struct {
	// Get is the fake for method UnknownValueClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, options *arraygroup.UnknownValueClientGetOptions) (resp azfake.Responder[arraygroup.UnknownValueClientGetResponse], errResp azfake.ErrorResponder)

	// Put is the fake for method UnknownValueClient.Put
	// HTTP status codes to indicate success: http.StatusNoContent
	Put func(ctx context.Context, body []any, options *arraygroup.UnknownValueClientPutOptions) (resp azfake.Responder[arraygroup.UnknownValueClientPutResponse], errResp azfake.ErrorResponder)
}

// NewUnknownValueServerTransport creates a new instance of UnknownValueServerTransport with the provided implementation.
// The returned UnknownValueServerTransport instance is connected to an instance of arraygroup.UnknownValueClient via the
...
// UnknownValueServerTransport connects instances of arraygroup.UnknownValueClient to instances of UnknownValueServer.
