...
// Don't use this type directly, use [ArrayClient.ModelValueClient] instead.
...
func (client *ModelValueClient) putCreateRequest(ctx context.Context, body []InnerModel, options *ModelValueClientPutOptions) (*policy.Request, error) {
	urlPath := "/type/array/model"
