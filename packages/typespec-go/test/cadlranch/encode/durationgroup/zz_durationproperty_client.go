...
func (client *DurationPropertyClient) defaultCreateRequest(ctx context.Context, body DefaultDurationProperty, options *DurationPropertyClientDefaultOptions) (*policy.Request, error) {
...
func (client *DurationPropertyClient) floatSecondsCreateRequest(ctx context.Context, body FloatSecondsDurationProperty, options *DurationPropertyClientFloatSecondsOptions) (*policy.Request, error) {
...
func (client *DurationPropertyClient) floatSecondsArrayCreateRequest(ctx context.Context, body FloatSecondsDurationArrayProperty, options *DurationPropertyClientFloatSecondsArrayOptions) (*policy.Request, error) {
...
func (client *DurationPropertyClient) iso8601CreateRequest(ctx context.Context, body ISO8601DurationProperty, options *DurationPropertyClientISO8601Options) (*policy.Request, error) {
...
func (client *DurationPropertyClient) int32SecondsCreateRequest(ctx context.Context, body Int32SecondsDurationProperty, options *DurationPropertyClientInt32SecondsOptions) (*policy.Request, error) {
