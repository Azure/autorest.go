...
func (client *DatetimeQueryClient) defaultCreateRequest(ctx context.Context, value time.Time, options *DatetimeQueryClientDefaultOptions) (*policy.Request, error) {
...
func (client *DatetimeQueryClient) rfc3339CreateRequest(ctx context.Context, value time.Time, options *DatetimeQueryClientRFC3339Options) (*policy.Request, error) {
...
func (client *DatetimeQueryClient) rfc7231CreateRequest(ctx context.Context, value time.Time, options *DatetimeQueryClientRFC7231Options) (*policy.Request, error) {
...
func (client *DatetimeQueryClient) unixTimestampCreateRequest(ctx context.Context, value time.Time, options *DatetimeQueryClientUnixTimestampOptions) (*policy.Request, error) {
...
func (client *DatetimeQueryClient) unixTimestampArrayCreateRequest(ctx context.Context, value []time.Time, options *DatetimeQueryClientUnixTimestampArrayOptions) (*policy.Request, error) {
