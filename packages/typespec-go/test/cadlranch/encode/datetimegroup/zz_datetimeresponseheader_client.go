...
func (client *DatetimeResponseHeaderClient) defaultCreateRequest(ctx context.Context, options *DatetimeResponseHeaderClientDefaultOptions) (*policy.Request, error) {
...
func (client *DatetimeResponseHeaderClient) rfc3339CreateRequest(ctx context.Context, options *DatetimeResponseHeaderClientRFC3339Options) (*policy.Request, error) {
...
func (client *DatetimeResponseHeaderClient) rfc7231CreateRequest(ctx context.Context, options *DatetimeResponseHeaderClientRFC7231Options) (*policy.Request, error) {
...
func (client *DatetimeResponseHeaderClient) unixTimestampCreateRequest(ctx context.Context, options *DatetimeResponseHeaderClientUnixTimestampOptions) (*policy.Request, error) {
