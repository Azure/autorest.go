...
func (client *BytesHeaderClient) base64CreateRequest(ctx context.Context, value []byte, options *BytesHeaderClientBase64Options) (*policy.Request, error) {
...
func (client *BytesHeaderClient) base64URLCreateRequest(ctx context.Context, value []byte, options *BytesHeaderClientBase64URLOptions) (*policy.Request, error) {
...
func (client *BytesHeaderClient) base64URLArrayCreateRequest(ctx context.Context, value [][]byte, options *BytesHeaderClientBase64URLArrayOptions) (*policy.Request, error) {
...
func (client *BytesHeaderClient) defaultCreateRequest(ctx context.Context, value []byte, options *BytesHeaderClientDefaultOptions) (*policy.Request, error) {
