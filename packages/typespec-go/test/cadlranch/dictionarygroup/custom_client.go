...
func NewRecursiveModelValueClient(options *azcore.ClientOptions) (*RecursiveModelValueClient, error) {
	internal, err := newClient(options)
	if err != nil {
		return nil, err
	}
...
func newClient(options *azcore.ClientOptions) (*azcore.Client, error) {
	return azcore.NewClient("dictionarygroup", "v0.1.0", runtime.PipelineOptions{}, options)
}
