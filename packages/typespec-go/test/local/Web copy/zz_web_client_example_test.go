...
// Generated from example definition: 2025-03-01/ListAseRegions.json
func ExampleWebClient_NewListAseRegionsPager() {
	...
	pager := clientFactory.NewWebClient().NewListAseRegionsPager(nil)
	for pager.More() {
		...
		// page = armappservice.WebClientListAseRegionsResponse{
...
// Generated from example definition: 2025-03-01/ListCustomHostNameSites.json
func ExampleWebClient_NewListCustomHostNameSitesPager_getCustomHostnamesUnderSubscription() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewWebClient().NewListCustomHostNameSitesPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.WebClientListCustomHostNameSitesResponse{
...
// Generated from example definition: 2025-03-01/ListCustomSpecificHostNameSites.json
func ExampleWebClient_NewListCustomHostNameSitesPager_getSpecificCustomHostnameUnderSubscription() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewWebClient().NewListCustomHostNameSitesPager(&armappservice.WebClientListCustomHostNameSitesOptions{
...
// Generated from example definition: 2025-03-01/VerifyHostingEnvironmentVnet.json
func ExampleWebClient_VerifyHostingEnvironmentVnet() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewWebClient().VerifyHostingEnvironmentVnet(ctx, armappservice.VnetParameters{
	...
	// res = armappservice.WebClientVerifyHostingEnvironmentVnetResponse{
