...
// MarshalJSON implements the json.Marshaller interface for type UserAssignedIdentityMap.
func (u UserAssignedIdentityMap) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UserAssignedIdentityMap.
func (u *UserAssignedIdentityMap) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %w", u, err)
	}
