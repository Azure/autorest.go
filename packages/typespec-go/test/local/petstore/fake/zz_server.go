...
// Server is a fake server for instances of the petstore.Client type.
type Server struct {
...
// The returned ServerTransport instance is connected to an instance of petstore.Client via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewServerTransport(srv *Server) *ServerTransport {
	return &ServerTransport{srv: srv}
}

// ServerTransport connects instances of petstore.Client to instances of Server.
