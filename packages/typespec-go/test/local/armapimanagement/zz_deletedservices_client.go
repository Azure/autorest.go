...
//     method.
func (client *DeletedServicesClient) GetByName(ctx context.Context, location string, serviceName string, options *DeletedServicesClientGetByNameOptions) (DeletedServicesClientGetByNameResponse, error) {
	var err error
	const operationName = "DeletedServicesClient.GetByName"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getByNameCreateRequest(ctx, location, serviceName, options)
	if err != nil {
...
func (client *DeletedServicesClient) getByNameCreateRequest(ctx context.Context, location string, serviceName string, _ *DeletedServicesClientGetByNameOptions) (*policy.Request, error) {
...
//     method.
func (client *DeletedServicesClient) BeginPurge(ctx context.Context, location string, serviceName string, options *DeletedServicesClientBeginPurgeOptions) (*runtime.Poller[DeletedServicesClientPurgeResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.purge(ctx, location, serviceName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-03-01-preview
func (client *DeletedServicesClient) purge(ctx context.Context, location string, serviceName string, options *DeletedServicesClientBeginPurgeOptions) (*http.Response, error) {
	var err error
	const operationName = "DeletedServicesClient.BeginPurge"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.purgeCreateRequest(ctx, location, serviceName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *DeletedServicesClient) purgeCreateRequest(ctx context.Context, location string, serviceName string, _ *DeletedServicesClientBeginPurgeOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.ApiManagement/locations/{location}/deletedservices/{serviceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
