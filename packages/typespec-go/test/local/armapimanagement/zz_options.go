...
// ServiceResourcesClientBeginPerformConnectivityCheckAsyncOptions contains the optional parameters for the ServiceResourcesClient.BeginPerformConnectivityCheckAsync
// method.
type ServiceResourcesClientBeginPerformConnectivityCheckAsyncOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
