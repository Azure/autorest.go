...
type ServerFactory struct {
	...
	// ServiceResourcesServer contains the fakes for client ServiceResourcesClient
	ServiceResourcesServer ServiceResourcesServer
...
type ServerFactoryTransport struct {
	...
	trServiceResourcesServer                     *ServiceResourcesServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ServiceResourcesClient":
		initServer(s, &s.trServiceResourcesServer, func() *ServiceResourcesServerTransport {
			return NewServiceResourcesServerTransport(&s.srv.ServiceResourcesServer)
		})
		resp, err = s.trServiceResourcesServer.Do(req)
