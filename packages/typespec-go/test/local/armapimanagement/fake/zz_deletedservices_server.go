...
type DeletedServicesServer struct {
	...
	GetByName func(ctx context.Context, location string, serviceName string, options *armapimanagement.DeletedServicesClientGetByNameOptions) (resp azfake.Responder[armapimanagement.DeletedServicesClientGetByNameResponse], errResp azfake.ErrorResponder)
	...
	BeginPurge func(ctx context.Context, location string, serviceName string, options *armapimanagement.DeletedServicesClientBeginPurgeOptions) (resp azfake.PollerResponder[armapimanagement.DeletedServicesClientPurgeResponse], errResp azfake.ErrorResponder)
}
...
func (d *DeletedServicesServerTransport) dispatchGetByName(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.GetByName(req.Context(), locationParam, serviceNameParam, nil)
...
func (d *DeletedServicesServerTransport) dispatchBeginPurge(req *http.Request) (*http.Response, error) {
	...
	if beginPurge == nil {
		...
		respr, errRespr := d.srv.BeginPurge(req.Context(), locationParam, serviceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginPurge = &respr
