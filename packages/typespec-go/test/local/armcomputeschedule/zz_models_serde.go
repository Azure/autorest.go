...
func (e *ExecuteDeleteRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "computeApiVersion":
			err = unpopulate(val, "ComputeAPIVersion", &e.ComputeAPIVersion)
			delete(rawMsg, key)
		case "correlationid":
			err = unpopulate(val, "Correlationid", &e.Correlationid)
			delete(rawMsg, key)
...
func (o OperationErrorDetails) MarshalJSON() ([]byte, error) {
	...
	datetime.PopulateDateTimeRFC3339(objectMap, "timeStamp", o.TimeStamp)
	datetime.PopulateDateTimeRFC3339(objectMap, "timestamp", o.Timestamp)
	return json.Marshal(objectMap)
}
...
func (o *OperationErrorDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "errorDetails":
			...
			delete(rawMsg, key)
		case "timeStamp":
			err = datetime.UnpopulateDateTimeRFC3339(val, "TimeStamp", &o.TimeStamp)
			delete(rawMsg, key)
		case "timestamp":
			err = datetime.UnpopulateDateTimeRFC3339(val, "Timestamp", &o.Timestamp)
			delete(rawMsg, key)
...
func (o OperationErrorsResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	datetime.PopulateDateTimeRFC3339(objectMap, "activationTime", o.ActivationTime)
	datetime.PopulateDateTimeRFC3339(objectMap, "completedAt", o.CompletedAt)
	datetime.PopulateDateTimeRFC3339(objectMap, "creationTime", o.CreationTime)
...
func (o *OperationErrorsResult) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "activationTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "ActivationTime", &o.ActivationTime)
			delete(rawMsg, key)
		case "completedAt":
			err = datetime.UnpopulateDateTimeRFC3339(val, "CompletedAt", &o.CompletedAt)
			delete(rawMsg, key)
		case "creationTime":
			err = datetime.UnpopulateDateTimeRFC3339(val, "CreationTime", &o.CreationTime)
			delete(rawMsg, key)
...
func (r ResourceOperationDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	datetime.PopulateDateTimeRFC3339(objectMap, "completedAt", r.CompletedAt)
	datetime.PopulateDateTimeRFC3339(objectMap, "deadline", r.Deadline)
...
func (r *ResourceOperationDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "completedAt":
			err = datetime.UnpopulateDateTimeRFC3339(val, "CompletedAt", &r.CompletedAt)
			delete(rawMsg, key)
		case "deadline":
			err = datetime.UnpopulateDateTimeRFC3339(val, "Deadline", &r.Deadline)
			delete(rawMsg, key)
		case "deadlineType":
...
func (s Schedule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	datetime.PopulateDateTimeRFC3339(objectMap, "deadLine", s.DeadLine)
	datetime.PopulateDateTimeRFC3339(objectMap, "deadline", s.Deadline)
...
func (s *Schedule) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "deadLine":
			err = datetime.UnpopulateDateTimeRFC3339(val, "DeadLine", &s.DeadLine)
			delete(rawMsg, key)
		case "deadline":
			err = datetime.UnpopulateDateTimeRFC3339(val, "Deadline", &s.Deadline)
			delete(rawMsg, key)
