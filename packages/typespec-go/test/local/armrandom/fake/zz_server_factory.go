...
// The returned ServerFactoryTransport instance is connected to an instance of armrandom.ClientFactory via the
...
// ServerFactoryTransport connects instances of armrandom.ClientFactory to instances of ServerFactory.
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SomeServiceClient":
		initServer(&s.trMu, &s.trSomeServiceServer, func() *SomeServiceServerTransport { return NewSomeServiceServerTransport(&s.srv.SomeServiceServer) })
