...
func ExampleCertificateOrdersDiagnosticsClient_GetAppServiceCertificateOrderDetectorResponse() {
	...
	clientFactory, err := armappservice.NewClientFactory("5700fc96-77b4-4f8d-afce-c353d8c443bd", cred, nil)
	if err != nil {
	...
	// res = armappservice.CertificateOrdersDiagnosticsClientGetAppServiceCertificateOrderDetectorResponseResponse{
...
func ExampleCertificateOrdersDiagnosticsClient_NewListAppServiceCertificateOrderDetectorResponsePager() {
	...
	for pager.More() {
		...
		// page = armappservice.CertificateOrdersDiagnosticsClientListAppServiceCertificateOrderDetectorResponseResponse{
