...
type Server struct {
	...
	UsageBySubscriptionSKU func(ctx context.Context, location string, skuName string, searchManagementRequestOptions armsearch.ManagementRequestOptions, options *armsearch.ClientUsageBySubscriptionSKUOptions) (resp azfake.Responder[armsearch.ClientUsageBySubscriptionSKUResponse], errResp azfake.ErrorResponder)
}
...
func (s *ServerTransport) dispatchUsageBySubscriptionSKU(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.UsageBySubscriptionSKU(req.Context(), locationParam, skuNameParam, searchManagementRequestOptions, nil)
