...
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the Client.UsageBySubscriptionSKU
//     method.
...
func (client *Client) UsageBySubscriptionSKU(ctx context.Context, location string, skuName string, searchManagementRequestOptions ManagementRequestOptions, options *ClientUsageBySubscriptionSKUOptions) (ClientUsageBySubscriptionSKUResponse, error) {
	var err error
...
func (client *Client) usageBySubscriptionSKUCreateRequest(ctx context.Context, location string, skuName string, searchManagementRequestOptions ManagementRequestOptions, _ *ClientUsageBySubscriptionSKUOptions) (*policy.Request, error) {
