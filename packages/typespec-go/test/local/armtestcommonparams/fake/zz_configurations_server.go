...
// ConfigurationsServer is a fake server for instances of the armtestcommonparams.ConfigurationsClient type.
type ConfigurationsServer struct {
	// GetContent is the fake for method ConfigurationsClient.GetContent
	// HTTP status codes to indicate success: http.StatusOK
	GetContent func(ctx context.Context, resourceGroupName string, configurationName string, options *armtestcommonparams.ConfigurationsClientGetContentOptions) (resp azfake.Responder[armtestcommonparams.ConfigurationsClientGetContentResponse], errResp azfake.ErrorResponder)

	// GetStreamingContent is the fake for method ConfigurationsClient.GetStreamingContent
	// HTTP status codes to indicate success: http.StatusOK
	GetStreamingContent func(ctx context.Context, resourceGroupName string, configurationName string, options *armtestcommonparams.ConfigurationsClientGetStreamingContentOptions) (resp azfake.Responder[armtestcommonparams.ConfigurationsClientGetStreamingContentResponse], errResp azfake.ErrorResponder)

	// PutStreamingContent is the fake for method ConfigurationsClient.PutStreamingContent
	// HTTP status codes to indicate success: http.StatusNoContent
	PutStreamingContent func(ctx context.Context, resourceGroupName string, configurationName string, body io.ReadSeekCloser, options *armtestcommonparams.ConfigurationsClientPutStreamingContentOptions) (resp azfake.Responder[armtestcommonparams.ConfigurationsClientPutStreamingContentResponse], errResp azfake.ErrorResponder)
}
...
// The returned ConfigurationsServerTransport instance is connected to an instance of armtestcommonparams.ConfigurationsClient via the
...
// ConfigurationsServerTransport connects instances of armtestcommonparams.ConfigurationsClient to instances of ConfigurationsServer.
