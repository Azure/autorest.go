...
// BodyRootsServer is a fake server for instances of the armtestcommonparams.BodyRootsClient type.
type BodyRootsServer struct {
	// Action is the fake for method BodyRootsClient.Action
	// HTTP status codes to indicate success: http.StatusNoContent
	Action func(ctx context.Context, resourceGroupName string, bodyRootName string, action armtestcommonparams.ActionRequest, options *armtestcommonparams.BodyRootsClientActionOptions) (resp azfake.Responder[armtestcommonparams.BodyRootsClientActionResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method BodyRootsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, bodyRootName string, options *armtestcommonparams.BodyRootsClientGetOptions) (resp azfake.Responder[armtestcommonparams.BodyRootsClientGetResponse], errResp azfake.ErrorResponder)

	// Put is the fake for method BodyRootsClient.Put
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Put func(ctx context.Context, resourceGroupName string, bodyRootName string, resource armtestcommonparams.BodyRoot, options *armtestcommonparams.BodyRootsClientPutOptions) (resp azfake.Responder[armtestcommonparams.BodyRootsClientPutResponse], errResp azfake.ErrorResponder)
}

// NewBodyRootsServerTransport creates a new instance of BodyRootsServerTransport with the provided implementation.
// The returned BodyRootsServerTransport instance is connected to an instance of armtestcommonparams.BodyRootsClient via the
...
// BodyRootsServerTransport connects instances of armtestcommonparams.BodyRootsClient to instances of BodyRootsServer.
...
func (b *BodyRootsServerTransport) dispatchPut(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armtestcommonparams.BodyRoot](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
