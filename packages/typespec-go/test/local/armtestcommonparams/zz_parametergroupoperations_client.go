...
//     method.
func (client *ParameterGroupOperationsClient) SharedParameterGroup1(ctx context.Context, resourceGroupName string, widgetName string, params TestManagementRequestOptions, options *ParameterGroupOperationsClientSharedParameterGroup1Options) (ParameterGroupOperationsClientSharedParameterGroup1Response, error) {
	var err error
...
func (client *ParameterGroupOperationsClient) sharedParameterGroup1CreateRequest(ctx context.Context, resourceGroupName string, widgetName string, params TestManagementRequestOptions, options *ParameterGroupOperationsClientSharedParameterGroup1Options) (*policy.Request, error) {
...
//     method.
func (client *ParameterGroupOperationsClient) SharedParameterGroup2(ctx context.Context, resourceGroupName string, widgetName string, params TestManagementRequestOptions, options *ParameterGroupOperationsClientSharedParameterGroup2Options) (ParameterGroupOperationsClientSharedParameterGroup2Response, error) {
	var err error
...
func (client *ParameterGroupOperationsClient) sharedParameterGroup2CreateRequest(ctx context.Context, resourceGroupName string, widgetName string, params TestManagementRequestOptions, options *ParameterGroupOperationsClientSharedParameterGroup2Options) (*policy.Request, error) {
