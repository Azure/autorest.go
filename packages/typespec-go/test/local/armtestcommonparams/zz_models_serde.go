...
// MarshalJSON implements the json.Marshaller interface for type TestLROModel.
func (t TestLROModel) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", t.ID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TestLROModel.
func (t *TestLROModel) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
