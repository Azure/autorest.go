...
func ExampleCloudHsmClustersClient_CloudHsmClusterBackupStatusGet() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewCloudHsmClustersClient().CloudHsmClusterBackupStatusGet(ctx, "rgcloudhsm", "chsm1", "572a45927fc240e1ac075de27371680b", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleCloudHsmClustersClient_CloudHsmClusterRestoreStatusGet() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewCloudHsmClustersClient().CloudHsmClusterRestoreStatusGet(ctx, "rgcloudhsm", "chsm1", "572a45927fc240e1ac075de27371680b", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleCloudHsmClustersClient_NewListByCloudHsmClusterPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewCloudHsmClustersClient().NewListByCloudHsmClusterPager("rgcloudhsm", "chsm1", nil)
	for pager.More() {
		...
		// page = armhardwaresecuritymodules.CloudHsmClustersClientListByCloudHsmClusterResponse{
