...
// MarshalJSON implements the json.Marshaller interface for type BackupParameterBody.
func (b BackupParameterBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "backupRequestProperties", b.BackupRequestProperties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BackupParameterBody.
func (b *BackupParameterBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "backupRequestProperties":
			err = unpopulate(val, "BackupRequestProperties", &b.BackupRequestProperties)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %w", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type ValidateBackupPropertiesParameterBody.
func (v ValidateBackupPropertiesParameterBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "backupRequestProperties", v.BackupRequestProperties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateBackupPropertiesParameterBody.
func (v *ValidateBackupPropertiesParameterBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "backupRequestProperties":
			err = unpopulate(val, "BackupRequestProperties", &v.BackupRequestProperties)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %w", v, err)
...
// MarshalJSON implements the json.Marshaller interface for type ValidateRestorePropertiesParameterBody.
func (v ValidateRestorePropertiesParameterBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "restoreRequestProperties", v.RestoreRequestProperties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ValidateRestorePropertiesParameterBody.
func (v *ValidateRestorePropertiesParameterBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %w", v, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "restoreRequestProperties":
			err = unpopulate(val, "RestoreRequestProperties", &v.RestoreRequestProperties)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %w", v, err)
