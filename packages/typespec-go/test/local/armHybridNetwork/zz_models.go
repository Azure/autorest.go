...
type ArmResourceDefinitionResourceElementTemplateDetails struct {
	// CONSTANT; The resource element template type.
	// Field has constant value TypeArmResourceDefinition, any specified value is ignored.
...
// ArtifactManifestListResult - The response of a ArtifactManifest list operation.
type ArtifactManifestListResult struct {
	// REQUIRED; The ArtifactManifest items on this page
...
// ArtifactStoreListResult - The response of a ArtifactStore list operation.
type ArtifactStoreListResult struct {
	// REQUIRED; The ArtifactStore items on this page
	Value []*ArtifactStore
...
type ArtifactStoreNetworkFabricControllerEndPointsList struct {
	// REQUIRED; The ArtifactStoreNetworkFabricControllerEndPoints items on this page
...
type ArtifactStorePrivateEndPointsListResult struct {
	// REQUIRED; The ArtifactStorePrivateEndPointsFormat items on this page
...
type AzureArcK8SClusterNFVIDetails struct {
	// CONSTANT; The NFVI type.
	// Field has constant value NFVITypeAzureArcKubernetes, any specified value is ignored.
	NfviType *NFVIType
...
type AzureArcKubernetesHelmApplication struct {
	// CONSTANT; The artifact type.
	// Field has constant value AzureArcKubernetesArtifactTypeHelmPackage, any specified value is ignored.
...
type AzureArcKubernetesNetworkFunctionTemplate struct {
	// CONSTANT; The network function type.
	// Field has constant value ContainerizedNetworkFunctionNFVITypeAzureArcKubernetes, any specified value is ignored.
...
type AzureCoreNFVIDetails struct {
	// CONSTANT; The NFVI type.
	// Field has constant value NFVITypeAzureCore, any specified value is ignored.
	NfviType *NFVIType
...
type AzureCoreNetworkFunctionArmTemplateApplication struct {
	// CONSTANT; The artifact type.
	// Field has constant value AzureCoreArtifactTypeArmTemplate, any specified value is ignored.
	ArtifactType *AzureCoreArtifactType
...
type AzureCoreNetworkFunctionTemplate struct {
	// CONSTANT; The network function type.
	// Field has constant value VirtualNetworkFunctionNFVITypeAzureCore, any specified value is ignored.
...
type AzureCoreNetworkFunctionVhdApplication struct {
	// CONSTANT; The artifact type.
	// Field has constant value AzureCoreArtifactTypeVhdImageFile, any specified value is ignored.
	ArtifactType *AzureCoreArtifactType
...
type AzureOperatorNexusClusterNFVIDetails struct {
	// CONSTANT; The NFVI type.
	// Field has constant value NFVITypeAzureOperatorNexus, any specified value is ignored.
	NfviType *NFVIType
...
type AzureOperatorNexusNetworkFunctionArmTemplateApplication struct {
	// CONSTANT; The artifact type.
	// Field has constant value AzureOperatorNexusArtifactTypeArmTemplate, any specified value is ignored.
	ArtifactType *AzureOperatorNexusArtifactType
...
type AzureOperatorNexusNetworkFunctionImageApplication struct {
	// CONSTANT; The artifact type.
	// Field has constant value AzureOperatorNexusArtifactTypeImageFile, any specified value is ignored.
	ArtifactType *AzureOperatorNexusArtifactType
...
type AzureOperatorNexusNetworkFunctionTemplate struct {
	// CONSTANT; The network function type.
	// Field has constant value VirtualNetworkFunctionNFVITypeAzureOperatorNexus, any specified value is ignored.
	NfviType *VirtualNetworkFunctionNFVIType
...
// CancelInformation - Cancels an ongoing long-running operation, only Put is supported now
type CancelInformation struct {
	// REQUIRED; The ARM id of the siteNetworkService resource.
...
// ComponentListResult - The response of a Component list operation.
type ComponentListResult struct {
	// REQUIRED; The Component items on this page
	Value []*Component
...
// ConfigurationGroupSchemaListResult - The response of a ConfigurationGroupSchema list operation.
type ConfigurationGroupSchemaListResult struct {
	// REQUIRED; The ConfigurationGroupSchema items on this page
...
// ConfigurationGroupValueListResult - The response of a configurationGroupValue list operation.
type ConfigurationGroupValueListResult struct {
	// REQUIRED; The configurationGroupValue items on this page
...
type ConfigurationValueWithSecrets struct {
	// CONSTANT; The value which indicates if configuration values are secrets
	// Field has constant value ConfigurationGroupValueConfigurationTypeSecret, any specified value is ignored.
	ConfigurationType *ConfigurationGroupValueConfigurationType
...
type ConfigurationValueWithoutSecrets struct {
	// CONSTANT; The value which indicates if configuration values are secrets
	// Field has constant value ConfigurationGroupValueConfigurationTypeOpen, any specified value is ignored.
	ConfigurationType *ConfigurationGroupValueConfigurationType
...
type ContainerizedNetworkFunctionDefinitionVersion struct {
	// CONSTANT; The network function type.
	// Field has constant value NetworkFunctionTypeContainerizedNetworkFunction, any specified value is ignored.
...
// NetworkFunctionDefinitionGroupListResult - The response of a NetworkFunctionDefinitionGroup list operation.
type NetworkFunctionDefinitionGroupListResult struct {
	// REQUIRED; The NetworkFunctionDefinitionGroup items on this page
...
type NetworkFunctionDefinitionResourceElementTemplateDetails struct {
	// CONSTANT; The resource element template type.
	// Field has constant value TypeNetworkFunctionDefinition, any specified value is ignored.
	ResourceElementType *Type
...
// NetworkFunctionDefinitionVersionListResult - The response of a NetworkFunctionDefinitionVersion list operation.
type NetworkFunctionDefinitionVersionListResult struct {
	// REQUIRED; The NetworkFunctionDefinitionVersion items on this page
...
// NetworkFunctionListResult - The response of a NetworkFunction list operation.
type NetworkFunctionListResult struct {
	// REQUIRED; The NetworkFunction items on this page
...
type NetworkFunctionValueWithSecrets struct {
	// CONSTANT; The value which indicates if NF values are secrets
	// Field has constant value NetworkFunctionConfigurationTypeSecret, any specified value is ignored.
	ConfigurationType *NetworkFunctionConfigurationType
...
type NetworkFunctionValueWithoutSecrets struct {
	// CONSTANT; The value which indicates if NF values are secrets
	// Field has constant value NetworkFunctionConfigurationTypeOpen, any specified value is ignored.
	ConfigurationType *NetworkFunctionConfigurationType
...
// NetworkServiceDesignGroupListResult - The response of a NetworkServiceDesignGroup list operation.
type NetworkServiceDesignGroupListResult struct {
	// REQUIRED; The NetworkServiceDesignGroup items on this page
...
// NetworkServiceDesignVersionListResult - The response of a networkServiceDesignVersion list operation.
type NetworkServiceDesignVersionListResult struct {
	// REQUIRED; The networkServiceDesignVersion items on this page
...
type OpenDeploymentResourceReference struct {
	// CONSTANT; The resource reference arm id type.
	// Field has constant value IDTypeOpen, any specified value is ignored.
	IDType *IDType
...
// ProxyArtifactOverviewListResult - The description for page model
type ProxyArtifactOverviewListResult struct {
	// REQUIRED; The description for value property
...
// ProxyArtifactVersionsOverviewListResult - The description for page model
...
type SecretDeploymentResourceReference struct {
	// CONSTANT; The resource reference arm id type.
	// Field has constant value IDTypeSecret, any specified value is ignored.
	IDType *IDType
...
// SiteNetworkServiceListResult - The response of a SiteNetworkService list operation.
type SiteNetworkServiceListResult struct {
	// REQUIRED; The SiteNetworkService items on this page
...
type VirtualNetworkFunctionDefinitionVersion struct {
	// CONSTANT; The network function type.
	// Field has constant value NetworkFunctionTypeVirtualNetworkFunction, any specified value is ignored.
	NetworkFunctionType *NetworkFunctionType
