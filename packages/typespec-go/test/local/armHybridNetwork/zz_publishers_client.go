...
//     method.
func (client *PublishersClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, publisherName string, parameters Publisher, options *PublishersClientBeginCreateOrUpdateOptions) (*runtime.Poller[PublishersClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, publisherName, parameters, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-03-30
func (client *PublishersClient) createOrUpdate(ctx context.Context, resourceGroupName string, publisherName string, parameters Publisher, options *PublishersClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "PublishersClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, publisherName, parameters, options)
	if err != nil {
		return nil, err
	}
...
func (client *PublishersClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, parameters Publisher, _ *PublishersClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *PublishersClient) Update(ctx context.Context, resourceGroupName string, publisherName string, parameters TagsObject, options *PublishersClientUpdateOptions) (PublishersClientUpdateResponse, error) {
	var err error
	const operationName = "PublishersClient.Update"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, publisherName, parameters, options)
	if err != nil {
...
func (client *PublishersClient) updateCreateRequest(ctx context.Context, resourceGroupName string, publisherName string, parameters TagsObject, _ *PublishersClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/publishers/{publisherName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
