...
// SiteNetworkServicesClientBeginCancelOperationOptions contains the optional parameters for the SiteNetworkServicesClient.BeginCancelOperation
// method.
type SiteNetworkServicesClientBeginCancelOperationOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
