...
func (a ArtifactAccessCredential) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "credentialType", a.CredentialType)
	return json.Marshal(objectMap)
}
...
// MarshalJSON implements the json.Marshaller interface for type CancelInformation.
func (c CancelInformation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "longRunningOperation", c.LongRunningOperation)
	populate(objectMap, "siteNetworkServiceReference", c.SiteNetworkServiceReference)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CancelInformation.
func (c *CancelInformation) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "longRunningOperation":
			err = unpopulate(val, "LongRunningOperation", &c.LongRunningOperation)
			delete(rawMsg, key)
		case "siteNetworkServiceReference":
			err = unpopulate(val, "SiteNetworkServiceReference", &c.SiteNetworkServiceReference)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (c ConfigurationGroupValuePropertiesFormat) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "configurationType", c.ConfigurationType)
	populate(objectMap, "provisioningState", c.ProvisioningState)
...
func (c ContainerizedNetworkFunctionTemplate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nfviType", c.NfviType)
	return json.Marshal(objectMap)
}
...
func (d DeploymentResourceIDReference) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "idType", d.IDType)
	return json.Marshal(objectMap)
}
...
func (r ResourceElementTemplate) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "name", r.Name)
	populate(objectMap, "type", r.ResourceElementType)
	return json.Marshal(objectMap)
}
...
func (v VirtualNetworkFunctionTemplate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "nfviType", v.NfviType)
	return json.Marshal(objectMap)
}
