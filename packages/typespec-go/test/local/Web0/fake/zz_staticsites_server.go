...
type StaticSitesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginCreateOrUpdateStaticSiteCustomDomain func(ctx context.Context, resourceGroupName string, name string, domainName string, staticSiteCustomDomainRequestPropertiesEnvelope armappservice.StaticSiteCustomDomainOverviewARMResource, options *armappservice.StaticSitesClientBeginCreateOrUpdateStaticSiteCustomDomainOptions) (resp azfake.PollerResponder[armappservice.StaticSitesClientCreateOrUpdateStaticSiteCustomDomainResponse], errResp azfake.ErrorResponder)
...
func (s *StaticSitesServerTransport) dispatchBeginCreateOrUpdateStaticSiteCustomDomain(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdateStaticSiteCustomDomain == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armappservice.StaticSiteCustomDomainOverviewARMResource](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
