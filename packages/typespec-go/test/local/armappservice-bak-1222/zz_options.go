...
// WebAppsClientBeginSwapSlotSlotOptions contains the optional parameters for the WebAppsClient.BeginSwapSlotSlot method.
type WebAppsClientBeginSwapSlotSlotOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
