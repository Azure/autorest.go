...
// UnmarshalJSON implements the json.Unmarshaller interface for type Certificate1.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CertificatePatchResource1.
func (c *CertificatePatchResource1) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
