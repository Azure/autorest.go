...
type CertificateOrderPatchResourceProperties struct {
	...
	Certificates map[string]*Certificate1
...
type StackMajorVersion struct {
	...
	AppSettingsDictionary map[string]map[string]any
	...
	SiteConfigPropertiesDictionary map[string]map[string]any
}
