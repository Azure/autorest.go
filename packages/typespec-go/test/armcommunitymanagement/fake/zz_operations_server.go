...
// OperationsServer is a fake server for instances of the armcommunitymanagement.OperationsClient type.
type OperationsServer struct {
	// NewListPager is the fake for method OperationsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armcommunitymanagement.OperationsClientListOptions) (resp azfake.PagerResponder[armcommunitymanagement.OperationsClientListResponse])
}

// NewOperationsServerTransport creates a new instance of OperationsServerTransport with the provided implementation.
// The returned OperationsServerTransport instance is connected to an instance of armcommunitymanagement.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armcommunitymanagement.OperationsClientListResponse]](),
	}
}
...
type OperationsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armcommunitymanagement.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armcommunitymanagement.OperationsClientListResponse, createLink func() string) {
