...
// Don't use this type directly, use NewHierarchyBuildingDogOperationsClientWithNoCredential() instead.
type HierarchyBuildingDogOperationsClient struct {
	internal *azcore.Client
	endpoint string
}

// HierarchyBuildingDogOperationsClientOptions contains the optional values for creating a [HierarchyBuildingDogOperationsClient].
type HierarchyBuildingDogOperationsClientOptions struct {
	azcore.ClientOptions
}

// NewHierarchyBuildingDogOperationsClientWithNoCredential creates a new instance of HierarchyBuildingDogOperationsClient with the specified values.
//   - endpoint - Service host
//   - options - Contains optional client configuration. Pass nil to accept the default values.
func NewHierarchyBuildingDogOperationsClientWithNoCredential(endpoint string, options *HierarchyBuildingDogOperationsClientOptions) (*HierarchyBuildingDogOperationsClient, error) {
	if options == nil {
		options = &HierarchyBuildingDogOperationsClientOptions{}
	}
	cl, err := azcore.NewClient(moduleName, moduleVersion, runtime.PipelineOptions{}, &options.ClientOptions)
	if err != nil {
		return nil, err
	}
	client := &HierarchyBuildingDogOperationsClient{
		endpoint: endpoint,
		internal: cl,
	}
	return client, nil
