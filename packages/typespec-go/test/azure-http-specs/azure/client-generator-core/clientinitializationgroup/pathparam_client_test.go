...
func TestPathParamClient_GetStandalone(t *testing.T) {
	client, err := clientinitializationgroup.NewPathParamClientWithNoCredential("sample-blob", "http://localhost:3000", nil)
...
func TestPathParamClient_WithQuery(t *testing.T) {
	...
	opts := &clientinitializationgroup.PathParamClientWithQueryOptions{
		Format: to.Ptr("text"),
	}
