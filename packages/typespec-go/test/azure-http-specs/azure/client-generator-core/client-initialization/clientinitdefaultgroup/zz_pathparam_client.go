...
// PathParamClient - Blob operations with path parameter that should be moved to client level
...
func NewPathParamClientWithNoCredential(endpoint string, blobName string, options *PathParamClientOptions) (*PathParamClient, error) {
	if options == nil {
...
func (client *PathParamClient) deleteStandaloneCreateRequest(ctx context.Context, _ *PathParamClientDeleteStandaloneOptions) (*policy.Request, error) {
	urlPath := "/azure/client-generator-core/client-initialization/default/path/{blobName}"
	if client.blobName == "" {
...
func (client *PathParamClient) getStandaloneCreateRequest(ctx context.Context, _ *PathParamClientGetStandaloneOptions) (*policy.Request, error) {
	urlPath := "/azure/client-generator-core/client-initialization/default/path/{blobName}/get-standalone"
	if client.blobName == "" {
		return nil, errors.New("parameter client.blobName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{blobName}", url.PathEscape(client.blobName))
...
func (client *PathParamClient) withQueryCreateRequest(ctx context.Context, options *PathParamClientWithQueryOptions) (*policy.Request, error) {
	urlPath := "/azure/client-generator-core/client-initialization/default/path/{blobName}/with-query"
	if client.blobName == "" {
		return nil, errors.New("parameter client.blobName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{blobName}", url.PathEscape(client.blobName))
