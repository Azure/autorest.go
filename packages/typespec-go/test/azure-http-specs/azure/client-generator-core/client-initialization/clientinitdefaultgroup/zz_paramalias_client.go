...
// ParamAliasClient - Operations demonstrating the @paramAlias decorator for renaming parameters in client code
...
func (client *ParamAliasClient) withAliasedNameCreateRequest(ctx context.Context, _ *ParamAliasClientWithAliasedNameOptions) (*policy.Request, error) {
	urlPath := "/azure/client-generator-core/client-initialization/default/param-alias/{blob}/with-aliased-name"
	if client.blobName == "" {
...
func (client *ParamAliasClient) withOriginalNameCreateRequest(ctx context.Context, _ *ParamAliasClientWithOriginalNameOptions) (*policy.Request, error) {
	urlPath := "/azure/client-generator-core/client-initialization/default/param-alias/{blobName}/with-original-name"
	if client.blobName == "" {
		return nil, errors.New("parameter client.blobName cannot be empty")
	}
