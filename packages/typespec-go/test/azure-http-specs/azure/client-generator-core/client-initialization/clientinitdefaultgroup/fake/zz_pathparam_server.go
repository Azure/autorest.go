...
// PathParamServer is a fake server for instances of the clientinitdefaultgroup.PathParamClient type.
type PathParamServer struct {
	// DeleteStandalone is the fake for method PathParamClient.DeleteStandalone
	// HTTP status codes to indicate success: http.StatusNoContent
	DeleteStandalone func(ctx context.Context, options *clientinitdefaultgroup.PathParamClientDeleteStandaloneOptions) (resp azfake.Responder[clientinitdefaultgroup.PathParamClientDeleteStandaloneResponse], errResp azfake.ErrorResponder)

	// GetStandalone is the fake for method PathParamClient.GetStandalone
	// HTTP status codes to indicate success: http.StatusOK
	GetStandalone func(ctx context.Context, options *clientinitdefaultgroup.PathParamClientGetStandaloneOptions) (resp azfake.Responder[clientinitdefaultgroup.PathParamClientGetStandaloneResponse], errResp azfake.ErrorResponder)

	// WithQuery is the fake for method PathParamClient.WithQuery
	// HTTP status codes to indicate success: http.StatusNoContent
	WithQuery func(ctx context.Context, options *clientinitdefaultgroup.PathParamClientWithQueryOptions) (resp azfake.Responder[clientinitdefaultgroup.PathParamClientWithQueryResponse], errResp azfake.ErrorResponder)
}

// NewPathParamServerTransport creates a new instance of PathParamServerTransport with the provided implementation.
// The returned PathParamServerTransport instance is connected to an instance of clientinitdefaultgroup.PathParamClient via the
...
// PathParamServerTransport connects instances of clientinitdefaultgroup.PathParamClient to instances of PathParamServer.
...
func (p *PathParamServerTransport) dispatchDeleteStandalone(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/azure/client-generator-core/client-initialization/default/path/(?P<blobName>[!#&$-.0-;=?-\[\]_a-zA-Z0-9~%@]+)`
...
func (p *PathParamServerTransport) dispatchGetStandalone(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/azure/client-generator-core/client-initialization/default/path/(?P<blobName>[!#&$-.0-;=?-\[\]_a-zA-Z0-9~%@]+)/get-standalone`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 2 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (p *PathParamServerTransport) dispatchWithQuery(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/azure/client-generator-core/client-initialization/default/path/(?P<blobName>[!#&$-.0-;=?-\[\]_a-zA-Z0-9~%@]+)/with-query`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 2 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	var options *clientinitdefaultgroup.PathParamClientWithQueryOptions
	if formatParam != nil {
		options = &clientinitdefaultgroup.PathParamClientWithQueryOptions{
			Format: formatParam,
		}
	}
