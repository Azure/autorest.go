...
// ClientLocationServer is a fake server for instances of the locationgroup.ClientLocationClient type.
type ClientLocationServer struct {
	...
	GetHealthStatus func(ctx context.Context, options *locationgroup.ClientLocationClientGetHealthStatusOptions) (resp azfake.Responder[locationgroup.ClientLocationClientGetHealthStatusResponse], errResp azfake.ErrorResponder)
}
...
// The returned ClientLocationServerTransport instance is connected to an instance of locationgroup.ClientLocationClient via the
...
// ClientLocationServerTransport connects instances of locationgroup.ClientLocationClient to instances of ClientLocationServer.
