...
var (
	...
	tenantIdExpected                       = "00000000-0000-0000-0000-000000000000"
	clientIdExpected                       = "00000000-0000-0000-0000-000000000000"
	locationExpected                       = "eastus"
	resourceGroupExpected                  = "test-rg"
	identityTypeSystemAssigendExpected     = "SystemAssigned"
	identityTypeSystemUserAssignedExpected = "SystemAssigned,UserAssigned"
)
