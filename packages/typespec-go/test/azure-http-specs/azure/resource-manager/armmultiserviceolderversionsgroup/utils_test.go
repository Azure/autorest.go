...
var (
	ctx           context.Context
	clientFactory *armmultiserviceolderversionsgroup.ClientFactory
...
func TestMain(m *testing.M) {
	...
	clientFactory, _ = armmultiserviceolderversionsgroup.NewClientFactory(subscriptionIdExpected, &azfake.TokenCredential{}, &arm.ClientOptions{
