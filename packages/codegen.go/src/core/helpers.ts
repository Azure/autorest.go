...
import { ensureDoNotEdit } from './copyright.js';

// Re-export from copyright module
export { doNotEditRegex, ensureDoNotEdit } from './copyright.js';
